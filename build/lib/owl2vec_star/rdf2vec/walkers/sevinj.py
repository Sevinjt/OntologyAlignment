...
class SevinjWalker(Walker):
            ...
            #for walk in tqdm(walks_copy):
                ...
                if len(neighbors) > 0:
                    ...
                    #Calculate the probability distribution for neighbor selection       
                        ...
                        if config['BASIC']['choose_only_one_neighbor'] == 'no':
                            for neighbor in neighbors:
                                ...
                                if n_n in self.class_onto2:
                                    self.set_wl_node2.add(n_n)
                        if config['BASIC']['choose_only_one_neighbor'] == 'yes':
    ...
    def extract(self, graph, instances):
        ...
        print("Coverage nodes", (len(walked_nodes)/len(allnodes))*100)
